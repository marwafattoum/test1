...
import { ClientPartial } from '../models/client-partial';
...
export class ClientControllerService extends BaseService {
  ...
  /**
   * Path part for operation clientControllerReplaceById
   */
  static readonly ClientControllerReplaceByIdPath = '/clients/{id}';
  ...
  replaceById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ClientControllerService.ClientControllerReplaceByIdPath, 'put');
    if (params) {
      rb.path('id', params.id, {});
  ...
  /**
   * Path part for operation clientControllerUpdateAll
   */
  static readonly ClientControllerUpdateAllPath = '/clients';
  ...
  updateAll$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ClientControllerService.ClientControllerUpdateAllPath, 'patch');
    if (params) {
      rb.query('where', params.where, {});
      rb.body(params.body, 'application/json');
    }
